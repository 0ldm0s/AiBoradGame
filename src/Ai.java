...
//					System.out.println(beliefStates(cardDiscard, gb.deck, p));
	...
	//L�b h�nd igennem - retunerer det bedste hint. 
	public int[] maxHints(GameBoard gb){
		...
		for (Player p : gb.getPlayers()) {
			...
			//For hver anden spiller - v�lg den spiller hvor du kan give mest information p� �n gang.
			//Her talt som antallet af 1-taller i deres cardInformation array.
			//Tager ikke h�jde for om de allerede ved det du siger. (Endnu!) <----------- DO THIS
